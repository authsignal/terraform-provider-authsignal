...
subcategory: ""
description: |-
  Manages a CLASSIC action. Manage its rules with authsignal_rule. Use authsignal_flow for FLOW actions.
---
...
- `default_user_action_result` (String) The result when none of the action's rules match. Allowed values: `ALLOW`, `CHALLENGE`, `REVIEW`, `BLOCK`.
